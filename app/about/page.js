          ...
          <div className="container-custom">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-6 animate-fade-in-up text-gray-900">
                About <span className="text-gradient-sun">Ragovate Digital</span>
              </h1>
          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="p-8 rounded-2xl animate-fade-in-up card-light">
                <div className="w-16 h-16 rounded-xl flex items-center justify-center mb-6 bg-sun-gradient">
        ...
        <section className="section-padding bg-gray-50">
          <div className="container-custom">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="p-8 lg:p-12 rounded-2xl card-light">
              ...
              {stats.map((stat, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-3xl md:text-4xl font-bold mb-2 text-sun-500">
                      {stat.number}
                    </div>
                ...
                {timeline.map((event, index) => (
                  ...
                  >
                    <div className="flex-shrink-0">
                      <div className="w-20 h-20 rounded-full flex items-center justify-center text-lg font-bold bg-sun-gradient text-white">
                        {event.year}
                      </div>
                    </div>
                    
                    <div className="flex-1 p-6 rounded-xl card-light">
